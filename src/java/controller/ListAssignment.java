...
public class ListAssignment extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        request.setAttribute("c", new AssignmentDAO().getCourseById(request.getParameter("cid")));
        request.setAttribute("lista", new AssignmentDAO().getAllAssignment(request.getParameter("cid")));
